...
![](images/grip/image9.webp){ loading=lazy, width=45% }
![](images/grip/image49.webp){ loading=lazy, width=45% }

Press fit two bearings into each geared lever

![](images/grip/image53.webp){ loading=lazy, width=45% }
...
![](images/grip/image7.webp){ loading=lazy, width=45% }
![](images/grip/image46.webp){ loading=lazy, width=45% }  
![](images/grip/image50.webp){ loading=lazy, width=45% }
![](images/grip/image34.webp){ loading=lazy, width=45% }
...
![](images/grip/image3.webp){ loading=lazy, width=45% }
...
![](images/grip/image64.webp){ loading=lazy, width=45% }
...
![](images/grip/image72.webp){ loading=lazy, width=45% }
![](images/grip/image70.webp){ loading=lazy, width=45% }
...
![](images/grip/image8.webp){ loading=lazy, width=45% }
![](images/grip/image32.webp){ loading=lazy, width=45% }

## Body Assembly

After printing, tear the ears off the mechanism lid print. Clean up the area the bridge was supporting with a sharp tool.

![](images/grip/image41.webp){ loading=lazy, width=45% }
...
![](images/grip/image1.webp){ loading=lazy, width=45% }
![](images/grip/image73.webp){ loading=lazy, width=45% }

![](images/grip/image52.webp){ loading=lazy, width=45% }
![](images/grip/image45.webp){ loading=lazy, width=45% }
...
![](images/grip/image63.webp){ loading=lazy, width=45% }
![](images/grip/image17.webp){ loading=lazy, width=45% }
...
![](images/grip/image62.webp){ loading=lazy, width=45% }
![](images/grip/image67.webp){ loading=lazy, width=45% }
...
![](images/grip/image71.webp){ loading=lazy, width=45% }
![](images/grip/image44.webp){ loading=lazy, width=45% }
...
![](images/grip/image16.webp){ loading=lazy, width=45% }
![](images/grip/image30.webp){ loading=lazy, width=45% }
...
![](images/grip/image20.webp){ loading=lazy, width=45% }
![](images/grip/image4.webp){ loading=lazy, width=45% }
...
![](images/grip/image58.webp){ loading=lazy, width=45% }
![](images/grip/image59.webp){ loading=lazy, width=45% }
...
![](images/grip/image68.webp){ loading=lazy, width=45% }
![](images/grip/image33.webp){ loading=lazy, width=45% }
...
![](images/grip/image36.webp){ loading=lazy, width=45% }
![](images/grip/image10.webp){ loading=lazy, width=45% }

Secure the motor and standoff to the back plate using four M3x16 screws

![](images/grip/image22.webp){ loading=lazy, width=45% }
...
![](images/grip/image13.webp){ loading=lazy, width=45% }
![](images/grip/image2.webp){ loading=lazy, width=45% }

Attach the camera mount assembly to the back plate with an M3x6 countersunk screw.

![](images/grip/image35.webp){ loading=lazy, width=45% }
...
![](images/grip/image60.webp){ loading=lazy, width=45% }
![](images/grip/image66.webp){ loading=lazy, width=45% }
...
![](images/grip/image19.webp){ loading=lazy, width=45% }
![](images/grip/image28.webp){ loading=lazy, width=45% }
...
![](images/grip/image11.webp){ loading=lazy, width=45% }
![](images/grip/image12.webp){ loading=lazy, width=45% }
...
![](images/grip/image6.webp){ loading=lazy, width=45% }
![](images/grip/image56.webp){ loading=lazy, width=45% }
![](images/grip/image42.webp){ loading=lazy, width=45% }
...
![](images/grip/image38.webp){ loading=lazy, width=45% }
![](images/grip/image55.webp){ loading=lazy, width=45% }
...
![](images/grip/image24.webp){ loading=lazy, width=45% }
![](images/grip/image57.webp){ loading=lazy, width=45% }
![](images/grip/image74.webp){ loading=lazy, width=45% }
...
![](images/grip/image54.webp){ loading=lazy, width=45% }
...
![](images/grip/image27.webp){ loading=lazy, width=45% }
![](images/grip/image31.webp){ loading=lazy, width=45% }
...
![](images/grip/image51.webp){ loading=lazy, width=45% }
...
![](images/grip/image37.webp){ loading=lazy, width=45% }
...
![](images/grip/image43.webp){ loading=lazy, width=45% }
...
![](images/grip/image25.webp){ loading=lazy, width=45% }
...
![](images/grip/image15.webp){ loading=lazy, width=45% }
...
![](images/grip/image29.webp){ loading=lazy, width=45% }

Attach the gear to the 270° servo with an allen wrench.

![](images/grip/image14.webp){ loading=lazy, width=45% }

Insert an M4x12 screw into the back plate in this hole, screwing it in just until it is flush with the inside surface.

![](images/grip/image5.webp){ loading=lazy, width=45% }
![](images/grip/image65.webp){ loading=lazy, width=45% }
...
??? example "Using the raspberry pi to manually move the servo"
	...
	![](images/grip/image40.webp){ loading=lazy, width=45% }
...
![](images/grip/image48.webp){ loading=lazy, width=45% }
![](images/grip/image18.webp){ loading=lazy, width=45% }
![](images/grip/image47.webp){ loading=lazy, width=45% }
...
![](images/grip/image13-g.webp){ loading=lazy, width=45% }
![](images/grip/image14-g.webp){ loading=lazy, width=45% }
![](images/grip/image1-g.webp){ loading=lazy, width=45% }
...
![](images/grip/image31-g.webp){ loading=lazy, width=45% }
![](images/grip/image32-g.webp){ loading=lazy, width=45% }
![](images/grip/image33-g.webp){ loading=lazy, width=45% }
...
![](images/grip/image15-g.webp){ loading=lazy, width=45% }
...
![](images/grip/image18-g.webp){ loading=lazy, width=45% }
...
![](images/grip/image21.webp){ loading=lazy, width=45% }
![](images/grip/image75.webp){ loading=lazy, width=45% }
![](images/grip/image77.webp){ loading=lazy, width=45% }

Tie a fishing swivel onto the end of the fishing line with a [palomar knot](https://www.animatedknots.com/palomar-knot).

![](images/grip/image78.webp){ loading=lazy, width=45% }

Put two peices of heat shink on the leads of a male JST 1.25 2P connector.

![](images/grip/image79.webp){ loading=lazy, width=45% }

Splice the grey/red wires and black/black wires. Activiate the heat shrink. keep heat away from the fishing line.

![](images/grip/image80.webp){ loading=lazy, width=45% }
![](images/grip/image81.webp){ loading=lazy, width=45% }
...
![](images/grip/image82.webp){ loading=lazy, width=45% }