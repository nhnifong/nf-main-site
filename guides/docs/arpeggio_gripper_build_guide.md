...
![](images/grip_arp/PXL_20260330_133246386.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_133317023.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_133400360.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_133444670.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260330_133509036.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_133721043.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_133816709.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260330_133909419.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_134037513.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_134113767.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_134148958.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260330_135418346.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_135449560.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_135501452.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_135507886.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_135521402.webp){ loading=lazy, width=45% }


In a perpendicular direction stick another sheet of adhesive foam over the fingertip, folding 10 mm around each side.

![](images/grip_arp/PXL_20260330_135546329.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_135613874.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_135618907.webp){ loading=lazy, width=45% }

Then with a hobby knife, cut away any excess foam.

![](images/grip_arp/PXL_20260330_135633225.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_135719443.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260330_135740587.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_135756602.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260330_140024529.webp){ loading=lazy, width=45% }

## Motors

Attach the aluminum servo horns to both motors with the included M3x6 center screw. Use the one with the ridges inside.

![](images/grip_arp/PXL_20260202_235656620.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260202_235805556.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260203_000043825.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260331_214540392.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_214646763.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260203_000701647.webp){ loading=lazy, width=45% }

Attach the finger motor to the outside of mechanism_lid with four of the smallest screws included with the motors.

![](images/grip_arp/PXL_20260331_214712028.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_214759179.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_214838930.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260331_214133074.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_214236736.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260331_214309109.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_214349018.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260331_214931771.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_215008361.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_215045528.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260331_215346279.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_215421357.webp){ loading=lazy, width=45% }

Secure the lid around the edges with four M3x8 screws

![](images/grip_arp/PXL_20260331_215229335.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_215323818.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260331_215453617.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260331_215530342.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/image11.webp){ loading=lazy, width=45% }

Press the Strinman Gripper Hat onto the raspberry pi.

![](images/grip_arp/PXL_20260203_002527211.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260307_163945036.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260307_001646350.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260307_001725647.MP.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260307_001727665.MP.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260303_144334089.webp){ loading=lazy, width=45% }

Open the gripper fingers. Attach the camera mount assembly to the back plate with an M3x6 countersunk screw.

![](images/grip_arp/PXL_20260203_003116011.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260203_003125474.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260203_003143036.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260203_004935923.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260203_005029210.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260203_005137842.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260203_005244290.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260203_005323886.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260203_005434275.webp){ loading=lazy, width=45% }

Attach this motor bracket to the gripper with two M3x8 screws.

![](images/grip_arp/PXL_20260203_005851153.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260203_005932229.webp){ loading=lazy, width=45% }

Plug the finger motor into the motor port on he Gripper Hat. Leave the wrist motor unconnected for now.

![](images/grip_arp/PXL_20260203_010458913.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260203_010504029.webp){ loading=lazy, width=45% }

## Fan

Attach a 30mm fan to the mechanism lid using two M3x8 screws in opposite corners. ensure the airflow points outwards.

![](images/grip_arp/PXL_20260306_233719266.MP.webp){ loading=lazy, width=45% }
![](images/grip_arp/PXL_20260306_233758557.webp){ loading=lazy, width=45% }
...
![](images/grip_arp/PXL_20260405_151055436.webp){ loading=lazy, width=45% } 
...
![](images/grip_arp/PXL_20260205_165525637.webp){ loading=lazy, width=45% } 
...
![](images/grip_arp/PXL_20260205_170146100.webp){ loading=lazy, width=45% } 
![](images/grip_arp/PXL_20260205_170203710.webp){ loading=lazy, width=45% } 
